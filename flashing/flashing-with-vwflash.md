...
Feel free to open a [GitHub issue](https://github.com/bri3d/VW_Flash/issues/new), but you **MUST** include the following 3 files if you want help:

`flash.log` , `flash_details.log`, and `udsoncan.log` . If you don't provide these 3 files (or you take phone pictures of your screen or some other ridiculous thing), we can't help you because we don't have information about what went wrong.